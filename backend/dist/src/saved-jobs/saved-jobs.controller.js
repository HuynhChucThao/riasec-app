...
let SavedJobsController = class SavedJobsController {
    ...
    toggleSave(userId, occupationId) {
...
__decorate([
    (0, common_1.Post)(':occupationId'),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __param(1, (0, common_1.Param)('occupationId', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", void 0)
], SavedJobsController.prototype, "toggleSave", null);
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __metadata("design:type", Function),
