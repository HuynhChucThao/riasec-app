...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'Nội dung câu hỏi không được để trống' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateQuestionDto.prototype, "content", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'Loại câu hỏi RIASEC không được để trống' }),
    (0, class_validator_1.IsIn)(['R', 'I', 'A', 'S', 'E', 'C'], {
